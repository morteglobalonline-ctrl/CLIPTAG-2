...
import { Mic, Sparkles, Copy, Check } from 'lucide-react';
...
const VoiceoverPage = () => {
  ...
  const voiceStyles = ['professional', 'casual', 'energetic', 'calm', 'authoritative'];
    ...
    <DashboardLayout>
      <div className="max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">AI Voiceover Scripts</h1>
          <p className="text-[#A1A1AA]">
            Transform your text into natural, professional voiceover scripts.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-[#0A0A0A] border border-[#27272A] rounded-xl p-6">
            <h2 className="text-lg font-semibold text-white mb-6">Voiceover Details</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Enter the text you want to convert to a voiceover script..."
                  rows={6}
          ...
          <div className="bg-[#0A0A0A] border border-[#27272A] rounded-xl p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold text-white">Optimized Script</h2>
              {result && (
                <button
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20">
                ...
                <p className="text-[#A1A1AA]">Optimizing your script...</p>
              </div>
            ) : result ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center">
                <Mic className="w-16 h-16 text-[#27272A] mb-4" />
                <p className="text-[#A1A1AA]">Your optimized script will appear here</p>
                <p className="text-[#52525B] text-sm mt-2">Enter your text and click generate</p>
              </div>
            )}
          </div>
        </div>
