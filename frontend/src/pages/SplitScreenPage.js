...
import { LayoutGrid, Sparkles, Copy, Check } from 'lucide-react';
...
const SplitScreenPage = () => {
  ...
  const styles = ['engaging', 'comparison', 'reaction', 'educational', 'before-after'];
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await axios.post(`${API}/generate/split-screen`, {
        video_topic: topic,
        style,
        duration
      }, {
    ...
    <DashboardLayout>
      <div className="max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Split Screen Content</h1>
          <p className="text-[#A1A1AA]">
            Design engaging dual-view content for maximum retention.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <Textarea
                  ...
                  placeholder="e.g., iPhone vs Android comparison, Reaction to viral TikTok, Before and after home renovation"
                  rows={3}
                  className="bg-[#121212] border-[#27272A] text-white placeholder:text-[#52525B] focus:border-[#FF5F1F] focus:ring-[#FF5F1F] resize-none"
                  data-testid="split-topic"
                />
              </div>
          ...
          <div className="bg-[#0A0A0A] border border-[#27272A] rounded-xl p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold text-white">Generated Concept</h2>
              {result && (
                <button
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20">
                ...
                <p className="text-[#A1A1AA]">Creating your concept...</p>
              </div>
            ) : result ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center">
                <LayoutGrid className="w-16 h-16 text-[#27272A] mb-4" />
                <p className="text-[#A1A1AA]">Your split screen concept will appear here</p>
