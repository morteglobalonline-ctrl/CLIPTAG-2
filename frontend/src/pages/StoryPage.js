...
const StoryPage = () => {
  ...
  const styles = ['dramatic', 'mysterious', 'heartwarming', 'suspenseful', 'educational'];
    ...
    <DashboardLayout>
      <div className="max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Create Story Videos</h1>
          <p className="text-[#A1A1AA]">
            Build compelling narrative videos perfect for faceless channels.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-[#0A0A0A] border border-[#27272A] rounded-xl p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold text-white">Generated Story</h2>
              {result && (
                <button
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20">
                ...
                <p className="text-[#A1A1AA]">Crafting your story...</p>
              </div>
            ) : result ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center">
                <BookOpen className="w-16 h-16 text-[#27272A] mb-4" />
                <p className="text-[#A1A1AA]">Your generated story will appear here</p>
